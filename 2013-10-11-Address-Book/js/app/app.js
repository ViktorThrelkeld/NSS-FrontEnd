...
function viewPersonAdded(person){
  var ul = '<ul class ="person"><li class="pic"><img class="img"></li><li class="name"></li><li class="address"></li><li class="web"></li><li class="email"></li></ul>';
  var $ul = $(ul);
  ...
  $ul.children('.email').text(person.email);
