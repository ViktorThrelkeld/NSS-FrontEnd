...
function initialize(){
  $(document).foundation();
  Δdb = new Firebase('https://vacation-bt.firebaseio.com/');
...
function htmlAddLocation(location){
  // var selection = '<select><option value ="1"></value><option value ="2"></value><option value ="3"></value><option value ="4"></value></select>';
  // $selection = $(selection);
  var $option = $('<option>');
